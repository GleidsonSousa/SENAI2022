...
create table registro_ticket(
    ...
    placa_car varchar(10) not null unique,
...
insert into registro_ticket values(default,1,'CIZ8920','44333810043',DATE_SUB(curdate(),INTERVAL 3 DAY),'08:00','','','','Aberto');
insert into registro_ticket values(default,3,'MWK7015','80821611089',DATE_SUB(curdate(),INTERVAL 3 DAY),'09:30','','','','Aberto');
insert into registro_ticket values(default,2,'EDL3Z90','07937014067',DATE_SUB(curdate(),INTERVAL 2 DAY),'10:00','','','','Aberto');
insert into registro_ticket values(default,2,'HXW3364','07937014067',DATE_SUB(curdate(),INTERVAL 4 DAY),'08:30','12:30',40.00,'Cartão Débito','Pago');
...
select r.ticket_id,v.numero_vaga as vagas, c.cpf as clientes, v.categoria_vaga , v.valor_h , ca.placa as carros, r.forma_pagamento, r.status_pag from clientes c
