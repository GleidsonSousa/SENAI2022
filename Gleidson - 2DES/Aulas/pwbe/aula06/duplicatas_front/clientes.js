var srcClientes = `http://localhost:3000/duplicatas/clientes`;
var clientes = [];
const allCli = document.querySelector("#addCli");
...
function preencheTabela() {
    ...
    clientes.forEach(e => {
        ...
        uf.innerHTML = e.uf;
        tels.innerHTML = `<img src='./images/telefone.png' width='40px' class='tels' onclick='mostraTels(${indice})'/>`
...
//var Clientes = document.querySelector(".indiceCli")

//     let novoCli =  Clientes.cloneNode(true)
//     novoCli.classList.remove("modelo")
//    novoCli.querySelector("#cod").innerHTML = e.cod_cli
//    novoCli.querySelector("#nome").innerHTML = e.nome
//    novoCli.querySelector("#endereco").innerHTML = e.endereco
//    novoCli.querySelector("#bairro").innerHTML = e.bairro
//    novoCli.querySelector("#cidade").innerHTML = e.cidade
//    novoCli.querySelector("#uf").innerHTML = e.uf
//     document.querySelector(".main").appendChild(novoCli)